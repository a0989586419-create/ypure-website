              ...
              <div className="relative bg-[#0a0a0a] rounded-2xl border border-white/5 overflow-hidden">
                ...
                <div className="w-full relative flex justify-center py-8 px-4">
                  <svg viewBox="0 0 400 600" className="w-full max-w-[420px] h-auto" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="177" y="168" textAnchor="middle" fill="white" fontSize="11" fontWeight="600" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.9)' }}>2 店</text>

                    {/* 台中 pin */}
                    <text x="162" y="162" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" style={{ textShadow: '0 1px 6px rgba(0,0,0,0.9)' }}>台中</text>
                    <g transform="translate(150, 170)">
                      <path d="M12 0C5.4 0 0 5.4 0 12c0 9 12 24 12 24s12-15 12-24C24 5.4 18.6 0 12 0z" fill="#DC2626" />
                      <circle cx="12" cy="12" r="5" fill="white" />
                    </g>
                    <text x="162" y="216" textAnchor="middle" fill="white" fontSize="11" fontWeight="600" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.9)' }}>1 店</text>

                    {/* 嘉義 pin */}
                    <text x="100" y="287" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" style={{ textShadow: '0 1px 6px rgba(0,0,0,0.9)' }}>嘉義</text>
                    <g transform="translate(88, 295)">
                      <path d="M12 0C5.4 0 0 5.4 0 12c0 9 12 24 12 24s12-15 12-24C24 5.4 18.6 0 12 0z" fill="#DC2626" />
                      <circle cx="12" cy="12" r="5" fill="white" />
                    </g>
                    <text x="100" y="341" textAnchor="middle" fill="white" fontSize="11" fontWeight="600" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.9)' }}>1 店</text>

                    {/* 高雄 pin */}
                    <text x="112" y="382" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" style={{ textShadow: '0 1px 6px rgba(0,0,0,0.9)' }}>高雄</text>
                    <g transform="translate(100, 390)">
                      <path d="M12 0C5.4 0 0 5.4 0 12c0 9 12 24 12 24s12-15 12-24C24 5.4 18.6 0 12 0z" fill="#DC2626" />
                      <circle cx="12" cy="12" r="5" fill="white" />
                    </g>
                    <text x="112" y="436" textAnchor="middle" fill="white" fontSize="11" fontWeight="600" style={{ textShadow: '0 1px 4px rgba(0,0,0,0.9)' }}>1 店</text>
